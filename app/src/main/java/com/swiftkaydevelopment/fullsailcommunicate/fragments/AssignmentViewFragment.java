...
/**
 * Created by Kevin Haines on 1/10/16.
 ...
 * Class Name: AssignmentViewFragment
 * Class Description:
 */
public class AssignmentViewFragment extends Fragment{
    public static final String TAG = "AssignmentViewFragment";

    private WebView mWebView;

    public static AssignmentViewFragment newInstance() {
        AssignmentViewFragment frag = new AssignmentViewFragment();
        return frag;
    }

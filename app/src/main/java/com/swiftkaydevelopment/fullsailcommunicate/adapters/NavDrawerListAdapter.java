...
import com.swiftkaydevelopment.fullsailcommunicate.ui.NavDrawerItem;
...
public class NavDrawerListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtTitle = (TextView) convertView.findViewById(R.id.swipeitemname);
       ...
       // convertView.getLayoutParams().height = 45;
